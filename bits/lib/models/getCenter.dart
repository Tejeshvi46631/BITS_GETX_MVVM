class getCenter {
  ...
  getCenter(
      {this.userCentreMappingId,
      this.loginId,
      this.centreId,
      this.fromDate,
      this.toDate});

  getCenter.fromJson(Map<String, dynamic> json) {
    userCentreMappingId = json['userCentreMappingId'];
    loginId =
  ...
  Map<String, dynamic> toJson() {
    ...
    data['userCentreMappingId'] = this.userCentreMappingId;
